...
public class YonghuController {
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if("老师".equals(role)){
            LaoshiEntity laoshi = laoshiService.selectById(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
            params.put("xueyuanzhuanyeTypes",laoshi.getXueyuanzhuanyeTypes());//老师只能查看自己学院的学生
        }
    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuEntity==null){
            ...
            if("老师".equals(role)){
                LaoshiEntity laoshi = laoshiService.selectById(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
                yonghu.setXueyuanzhuanyeTypes(laoshi.getXueyuanzhuanyeTypes());
            }
