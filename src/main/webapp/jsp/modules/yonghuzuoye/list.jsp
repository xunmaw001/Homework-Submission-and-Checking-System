...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">回答作业管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">回答作业管理</li>
                            <li class="breadcrumb-item active">回答作业列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">回答作业列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        学院专业类型
                                        <div class="layui-input-inline">
                                            <select name="xueyuanzhuanyeTypesSelectSearch"  style="width: 150px;" id="xueyuanzhuanyeTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
        var xueyuanzhuanyeTypesOptions = [];
        ...
        <!-- 级联表的级联字典表 -->
            ...
            var xueyuanzhuanyeTypesSelectSearchInput = document.getElementById("xueyuanzhuanyeTypesSelectSearch");
            if(xueyuanzhuanyeTypesSelectSearchInput != null){
                var xueyuanzhuanyeTypesIndex = xueyuanzhuanyeTypesSelectSearchInput.selectedIndex;
                if( xueyuanzhuanyeTypesIndex  != 0){
                    searchForm.xueyuanzhuanyeTypes = document.getElementById("xueyuanzhuanyeTypesSelectSearch").options[xueyuanzhuanyeTypesIndex].value;
                }
            }
        ...
        function getDataList() {
            ...
            //级联表的
                ...
                xueyuanzhuanyeTypes: searchForm.xueyuanzhuanyeTypes,
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(sexTypesCell);
                        ...
                        //学院专业类型
            var xueyuanzhuanyeTypesCell = document.createElement('td');
            xueyuanzhuanyeTypesCell.innerHTML = item.xueyuanzhuanyeValue;
            row.appendChild(xueyuanzhuanyeTypesCell);
            ...
            row.appendChild(zuoyeContentCell);
                ...
                //回答作业
            var yonghuzuoyeFileCell = document.createElement('td');
            if(item.yonghuzuoyeFile ==null || item.yonghuzuoyeFile == '' || item.yonghuzuoyeFile == 'null'){
                    yonghuzuoyeFileCell.innerHTML = '没有下载文件';
            }else {
                var yonghuzuoyeFileFile = document.createElement('button');
                    yonghuzuoyeFileFile.innerHTML = '下载';
                var yonghuzuoyeFileFileAttr = "download('" + item.yonghuzuoyeFile + "')"
                    yonghuzuoyeFileFile.setAttribute('onclick',yonghuzuoyeFileFileAttr);
                    yonghuzuoyeFileCell.appendChild(yonghuzuoyeFileFile);
            }
            row.appendChild(yonghuzuoyeFileCell);
            ...
            //分数
            var yonghuzuoyeFenshuCell = document.createElement('td');
            yonghuzuoyeFenshuCell.innerHTML = item.yonghuzuoyeFenshu;
            row.appendChild(yonghuzuoyeFenshuCell);


                //批改详情
            var yonghuzuoyeContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.yonghuzuoyeContent && item.yonghuzuoyeContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.yonghuzuoyeContent.indexOf('<img');
                var endIndex = item.yonghuzuoyeContent.indexOf('>');
                    yonghuzuoyeContentCell.innerHTML = item.yonghuzuoyeContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.yonghuzuoyeContent != null && item.yonghuzuoyeContent != "" && item.yonghuzuoyeContent.length >= 11) {
                        yonghuzuoyeContentCell.innerHTML = item.yonghuzuoyeContent.substring(0, 10) + "...";
                } else {
                        yonghuzuoyeContentCell.innerHTML = item.yonghuzuoyeContent;
                }
            }
            row.appendChild(yonghuzuoyeContentCell);
            ...
            var zuoyeEndTime = new Date(item.zuoyeEndTime).getTime(); // 作业截止时间
            var date = new Date().getTime(); // 当前时间


            if(window.sessionStorage.getItem('role') == '管理员' || window.sessionStorage.getItem('role') == '老师'
                || (window.sessionStorage.getItem('role') == '用户' && (date- zuoyeEndTime)<0)
            ){
                //修改按钮
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("yonghuzuoye/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addyonghuzuoye", "addyonghuzuoye");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充级联表搜索下拉框
        ...
        function xueyuanzhuanyeTypesSelectSearch() {
            var xueyuanzhuanyeTypesSelectSearch = document.getElementById('xueyuanzhuanyeTypesSelectSearch');
            if(xueyuanzhuanyeTypesSelectSearch != null) {
                xueyuanzhuanyeTypesSelectSearch.add(new Option('-请选择-',''));
                if (xueyuanzhuanyeTypesOptions != null && xueyuanzhuanyeTypesOptions.length > 0){
                    for (var i = 0; i < xueyuanzhuanyeTypesOptions.length; i++) {
                            xueyuanzhuanyeTypesSelectSearch.add(new Option(xueyuanzhuanyeTypesOptions[i].indexName, xueyuanzhuanyeTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询级联表搜索条件所有列表
            function xueyuanzhuanyeTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueyuanzhuanye_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        xueyuanzhuanyeTypesOptions = res.data.list;
                    }
                });
            }
    ...
    //查询当前表搜索条件所有列表
        ...
        //级联表的下拉框赋值
            ...
            xueyuanzhuanyeTypesSelectSearch();
