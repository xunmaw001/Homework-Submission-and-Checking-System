                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>作业截止时间</label>
                                    <input id="zuoyeEndTime-input" name="zuoyeEndTime" type="text" class="form-control layui-input">
                                </div>
                                <div class="form-group  col-md-6">
                                    <label>作业详情</label>
...
<script>
    ...
    function dataBind() {
        ...
        $("#zuoyeEndTime-input").val(ruleForm.zuoyeEndTime);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            debugger
            if(window.sessionStorage.getItem('addzuoye') != null && window.sessionStorage.getItem('addzuoye') !=""){//修改不会查,新增查
                // 查询当前登录账户的信息
                var userId = window.sessionStorage.getItem('userId');
                laoshiSelectOne(userId);
            }
        }
    }
