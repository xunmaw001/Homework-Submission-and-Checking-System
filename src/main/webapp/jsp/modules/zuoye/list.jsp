...
<!--/Pre Loader -->
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            var zuoyeEndTimeStartSearch = $('#zuoyeEndTimeStartSearch');
            if( zuoyeEndTimeStartSearch != null){
                if (zuoyeEndTimeStartSearch.val() != null && zuoyeEndTimeStartSearch.val() != '') {
                    searchForm.zuoyeEndTimeStart = $('#zuoyeEndTimeStartSearch').val();
                }
            }
            var zuoyeEndTimeEndSearch = $('#zuoyeEndTimeEndSearch');
            if( zuoyeEndTimeEndSearch != null){
                if (zuoyeEndTimeEndSearch.val() != null && zuoyeEndTimeEndSearch.val() != '') {
                    searchForm.zuoyeEndTimeEnd = $('#zuoyeEndTimeEndSearch').val();
                }
            }
                    getDataList();
        }
