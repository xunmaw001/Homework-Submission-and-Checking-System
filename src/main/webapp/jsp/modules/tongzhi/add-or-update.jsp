                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="laoshiId" name="laoshiId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>通知名称</label>
                                        <input id="tongzhiName" name="tongzhiName" class="form-control"
                                               placeholder="通知名称">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>通知类型</label>
                                        <select id="tongzhiTypesSelect" name="tongzhiTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>通知详情</label>
...
<script>
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            if(window.sessionStorage.getItem('addtongzhi') != null && window.sessionStorage.getItem('addtongzhi') !="") {//修改不查,新增查
                // 查询当前登录账户的信息
                var userId = window.sessionStorage.getItem('userId');
